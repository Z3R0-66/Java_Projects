            ...
            <div class="col-md-4">
                ...
                <form method="POST">
                    <div class="formgroup-">
                        ...
                        <textarea class="form-control" name="feedback" id="login-username" type="text" value="" placeholder="Feedback" rows="4" cols="50">
                        </textarea>
                        <br>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="btn btn-primary btn-block" type="submit" value="Submit Feedback" formaction="Management?action=submitfb"> 
                    </div>
                     ${passMessage}
                </form>
            </div>
