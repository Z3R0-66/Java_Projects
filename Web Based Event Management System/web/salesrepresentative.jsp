                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="Management?action=feedback"><i class="fa fa-comment" aria-hidden="true"></i> Customer Feedbacks</a></li>
     ...
     <section class="container login-form-section">
        ...
        <div class="row">
            <div class="col-md-4"></div>
                <h1 class="text-center">My Halls</h1>
        </div>
    </section>
    <section class="container login-form-section">
        ...
        <%
            ...
            if(user!=null)
            {
                ...
                List<Hall> listOfMyHalls=userDAO.getHallsByOwnerId(user.getUserId());
        %>
                <tr>
        ...
        <%
                for (int i=0;i<listOfMyHalls.size();i++)
                {
        %>
                    <tr>
                        <td style="width:15%;border:solid"><%=listOfMyHalls.get(i).getHallId()%></td>
                        <td style="width:15%;border:solid"><%=listOfMyHalls.get(i).getHallName()%></td>
                        <td style="width:15%;border:solid"><%=listOfMyHalls.get(i).getHallPlace()%></td>
                        <td style="width:15%;border:solid"><%=listOfMyHalls.get(i).getHallPrice()%></td>
                        <td style="width:40%;border:solid;padding-left: 15px; padding-right: 15px;"><%=listOfMyHalls.get(i).getHallDetails()%></td>
                    </tr>
                    <br>
        <%
                }
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <form method="POST">
                ...
                <input class="btn btn-primary btn-block" type="submit" value="Add Hall" formaction="Management?action=add">
                <input class="btn btn-primary btn-block" type="submit" value="Edit Hall" formaction="Management?action=edith">
